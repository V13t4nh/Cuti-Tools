...
export type AuctionLot = { lot_id: string; source: string; title: string; subtitle: string | null; url: string; bidding_end_at: string | null; status: string; cover: AuctionLotCover; hammer_eur?: number | null; sold?: boolean | null; bids_count?: number | null; hearts?: number | null; needs_review?: number | null; unclassified_reason?: string | null; highest_bid_eur?: number | null; source_available?: number | boolean | null; review_status?: string | null; condition_tag?: 'naked' | 'box' | 'papers' | 'fullset' | null; quality?: 'new_unworn' | 'very_good' | 'good' | 'fair' | string | null; movement?: string | null; case_material?: string | null; case_diameter_mm?: number | null }
